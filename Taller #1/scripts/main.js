...
function mostrarInformacionSeries(series) {
    ...
    for (let se of series) {
        ...
        trElement.innerHTML = `
            ...
            <td><a href="${se.website}" target="_blank">Website</a></td>
            <td><img src="${se.imageUrl}" alt="${se.title}" width="100"></td>`;
